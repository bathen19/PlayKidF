...
//    public static void CreateAppUser(Map<String, Object> details) {
...
public static void createSavingsListener(){
    DocumentReference docRef = FirebaseFirestore.getInstance().collection(UserSingleton.sherdInstance().getPhoneNumber()).document("savings");
